...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
       ...
       var a = intent.extras!!
        ...
        var b = a.getDouble("dato1")
        var c = a.getDouble("dato2")
        var d = a.getString("lugar")
        this.setTitle("Ir a "+d)
        ...
        val marcador = LatLng(b, c)
        mMap.addMarker(MarkerOptions().position(marcador).title(d))
